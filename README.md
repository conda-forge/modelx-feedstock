...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/modelx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15191&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/modelx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `modelx` can be installed with:

```
conda install modelx
```

It is possible to list all of the versions of `modelx` available on your platform with:
